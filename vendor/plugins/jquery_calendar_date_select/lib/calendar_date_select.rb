...
if Object.const_defined?(:Rails) && File.directory?(Rails.root.to_s + "/public")  
  ...
  unless File.exists?(Rails.root + 'public/javascripts/calendar_date_select/calendar_date_select.js')
    ['public', 'public/javascripts/calendar_date_select', 'public/javascripts/calendar_date_select/jquery', 'public/stylesheets/calendar_date_select', 'public/images/calendar_date_select', 'public/javascripts/calendar_date_select/locale'].each do |dir|
      source = File.dirname(__FILE__) + "/../#{dir}"
      dest = (Rails.root + dir).to_s
